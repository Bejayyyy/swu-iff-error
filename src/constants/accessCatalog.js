...
export const ACCESS_CATALOG = [
  {
    ...
    items: [
      ...
      { type: 'nav', navKey: 'teachers', label: 'Teachers', description: 'View teachers in your college' },
      { type: 'nav', navKey: 'courses', label: 'Courses', description: 'Manage course catalog' },
