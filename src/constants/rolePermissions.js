...
export const NAV_ITEMS = {
  ...
  courses: { label: 'Courses', path: '/courses', permission: null },
...
const ROLE_NAV_KEYS = {
  [ROLES.REGISTRAR]: [
    'dashboard', 'approvals', 'approvalWorkflow', 'courseScheduling', 'teachers', 'courses', 'roomAvailability', 'roomFinder',
    'scheduleHistory', 'buildings', 'academicCalendar', 'reports', 'collegeInventory', 'systemAdmin',
  ],
  [ROLES.DEAN]: [
    'dashboard', 'approvals', 'courseScheduling', 'teachers', 'courses', 'roomAvailability',
